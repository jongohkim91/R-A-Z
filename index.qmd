...
![](img/tidyverse.png){fig.align="center"} \## My personal choice for R
packages
...
## My personal decision tree for R packages
...
3.  or manual type the function name in the search bar of the Help
...
You can change the suffix setting if ".x" & ".y" does not help you have
...
[the github page](https://github.com/jongohkim91/R-A-Z/blob/master/markdown)
