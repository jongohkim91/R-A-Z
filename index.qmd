...
This training aims to teach you A-Z in terms of data analysis.
:::
...
For more details of running different regressions, please check this webiste: [*Intorduction to Econometrics with R*](https://www.econometrics-with-r.org/index.html).
